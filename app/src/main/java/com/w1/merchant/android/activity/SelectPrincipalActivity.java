...
public class SelectPrincipalActivity extends ActivityBase {
    ...
    public static final String RESULT_PRINCIPAL = "com.w1.merchant.android.activity.SelectPrincipalActivity.RESULT_PRINCIPAL";

    public static final String RESULT_AUTH_USER = "com.w1.merchant.android.activity.SelectPrincipalActivity.RESULT_AUTH_USER";
