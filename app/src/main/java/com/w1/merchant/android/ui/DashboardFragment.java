...
import com.w1.merchant.android.ui.chart.DayStatsLineChartFragment;
import com.w1.merchant.android.ui.chart.WeekMonthStatsLineChartFragment;
import com.w1.merchant.android.utils.NetworkUtils;
import com.w1.merchant.android.utils.RetryWhenCaptchaReady;
import com.w1.merchant.android.ui.widget.SegmentedRadioGroup;
...
public class DashboardFragment extends Fragment  implements
        DayStatsLineChartFragment.OnFragmentInteractionListener,
        WeekMonthStatsLineChartFragment.OnFragmentInteractionListener{
                ...
                switch (scrollState) {
                    case OnScrollListener.SCROLL_STATE_IDLE:
                        ...
                        if (mFooter.isShown() && mFooter.getLocalVisibleRect(scrollBounds)) {
                            Log.v("DashboardFragment", "loading");
                            mCurrentPage += 1;
    ...
    private void refreshGraphFragments() {
        if (DBG) Log.v(TAG, "DashboardFragment: refreshGraphFragments");
        for (Fragment fragment: mFragments) {
            if (fragment instanceof DayStatsLineChartFragment) {
                ((DayStatsLineChartFragment) fragment).reloadData();
            } else if (fragment instanceof WeekMonthStatsLineChartFragment) {
                ((WeekMonthStatsLineChartFragment) fragment).reloadData();
            }
        }
    }
    ...
    private static class GraphicsAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return DayStatsLineChartFragment.newInstance();
                case 1:
                    return WeekMonthStatsLineChartFragment.newInstanceWeekStats();
                case 2:
                    return WeekMonthStatsLineChartFragment.newInstanceMonthStats();
                default:
