package com.w1.merchant.android.activity.graphs;
...
public class WeekMonthGraphFragment extends Fragment {
    ...
    public static WeekMonthGraphFragment newInstanceWeekStats() {
        WeekMonthGraphFragment instance = new WeekMonthGraphFragment();
    ...
    public static WeekMonthGraphFragment newInstanceMonthStats() {
        WeekMonthGraphFragment instance = new WeekMonthGraphFragment();
        Bundle args = new Bundle(1);
    ...
    public void reloadData() {
        if (DBG) Log.v(TAG, "WeekMonthGraphFragment " + mStatsType + " reloadData");
        mStats.clear();
        loadStats();
    }
    ...
    private void refreshDashboard(boolean animate) {
        ...
        DayGraphFragment.setupPercent(mPercentView, percent);
    }
    ...
    private void setPlot(String dataPlotX[], BigDecimal dataPlotY[], boolean animate) {
        ...
        LineDataSet set = DayGraphFragment.createLineDataSet(yVals);
