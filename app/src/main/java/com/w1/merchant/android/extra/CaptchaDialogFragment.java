...
public class CaptchaDialogFragment extends DialogFragment {
    ...
    public void onStart() {
        ...
        if (getArguments().getBoolean(ARG_SHOW_INVALID_CODE)) {
            ...
            if (mCaptcha == null) {
                ...
                Toast.makeText(getActivity(), R.string.captcha_wrong_code, Toast.LENGTH_LONG).show();
    ...
    private void recreateCaptcha() {
        ...
        api.createCaptchaCode(req, new Callback<Captcha>() {
            @Override
            public void success(Captcha captcha, Response response) {
